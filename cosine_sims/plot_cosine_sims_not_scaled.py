...
input_directory = '/scratch/users/apd1995/SAE_toxicity/embeddings_data/cosine_similarity_results_not_scaled'
output_directory = os.path.join(input_directory, 'cosine_similarity_plots_not_scaled')
