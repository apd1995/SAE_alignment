...
svd_directory = os.path.join(input_directory, 'svd_results_not_scaled')
logreg_directory = os.path.join(input_directory, 'logistic_regression_models_not_scaled')
output_directory = os.path.join(input_directory, 'cosine_similarity_results_not_scaled')
