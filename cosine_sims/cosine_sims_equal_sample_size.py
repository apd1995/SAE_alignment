...
svd_directory = os.path.join(input_directory, 'svd_results_equal_sample_size')
logreg_directory = os.path.join(input_directory, 'logistic_regression_models_equal_sample_size')
output_directory = os.path.join(input_directory, 'cosine_similarity_results_equal_sample_size')
